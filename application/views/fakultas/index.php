<div class="relative">
	...
	<div class="col-md-9 col-bordered">
		<div class="heading">
			...
			<div style="text-align:right;"><a href="<?php echo base_url()?>/fakultas/add" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambahkan Data</a></div>
		</div>
			...
			<tbody>
				...
				foreach($result as $data){
					echo "<tr class='tr".$data['id']."'>
						...
						<td>$data[dekan]</td>
						<td>
							<a href='".base_url()."/fakultas/edit/".$data['id']."'><i class='fa fa-edit edit-table'></i></a> | 
